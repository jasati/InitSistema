(function() {
    ...
    LoginFuncService.$inject = ['$state','$q','DataserviseProvider','UsuarioService', 'logger', '$cookies', 'config','EmpresaService','UtilsFunctions','LicencasService'];
    /* @ngInject */
    function LoginFuncService($state,$q,DataserviseProvider, UsuarioService, logger, $cookies, config,EmpresaService,UtilsFunctions,LicencasService) {
