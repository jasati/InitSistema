(function() {
    ...
    angular
        .module('app.ecc')
        .factory('EncontristasReport', EncontristasReport);
    EncontristasReport.$inject = ['UtilsFunctions'];
    /* @ngInject */
    function EncontristasReport(UtilsFunctions) {
        var service = {
            listagem: listagem,
        };
        return service;
