        ...
        function funcoes() {
          ...
          vm.filtrar = function () {
            ...
            if (isset(vm.pessoa.filtros.mainField)) {
              query += " and CONCAT(CASE WHEN p.nome_comp IS NULL THEN '' ELSE p.nome_comp END,CASE WHEN p.nome_red IS NULL THEN '' ELSE p.nome_red END) LIKE '%"+vm.pessoa.filtros.mainField+"%'";
            }
