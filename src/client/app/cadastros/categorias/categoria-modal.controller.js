(function(){
    ...
    CategoriaModalController.$inject = ['Categorias', '$modalInstance', '$scope','$filter', '$modal', 'CategoriaService'];
    /* @ngInject */
    function CategoriaModalController(Categorias, $modalInstance, $scope, $filter, $modal, CategoriaService) {
        var vm = this;
        vm.title = 'Cadastro de Categorias';
