(function(){
    ...
    SubCategoriaModalController.$inject = ['Data', '$modalInstance', '$scope','$filter', '$modal', 'SubCategoriaService'];
    /* @ngInject */
    function SubCategoriaModalController(Data, $modalInstance, $scope, $filter, $modal, SubCategoriaService) {
        var vm = this;
        vm.title = 'Cadastro de Sub-Categorias';
